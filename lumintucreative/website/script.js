...
function initNavbarSearch() {
  ...
  if (!searchContainer || !searchToggle || !searchInput || !searchDropdown)
    return;

  const searchItems = [
    {
      title: "Home / Beranda",
      desc: "Halaman utama LUMINTU Creative Visual",
      url: "#home",
      tags: ["home", "beranda", "hero", "lumintu", "visual"],
    },
    {
      title: "About Us",
      desc: "Tentang kami & filosofi kreasi visual",
      url: "#about",
      tags: ["about", "tentang", "profil", "siapa kami", "ide"],
    },
    {
      title: "Why Us",
      desc: "Keunggulan memilih LUMINTU sebagai partner",
      url: "#why-us",
      tags: ["why", "kenapa", "keunggulan", "alasan", "kualitas"],
    },
    {
      title: "Services",
      desc: "Semua layanan event, multimedia & desain",
      url: "#services",
      tags: ["services", "layanan", "jasa", "service"],
    },
    {
      title: "Event Production",
      desc: "Tata panggung & visual experience event",
      url: "#services",
      tags: ["event", "acara", "panggung", "gathering", "konser"],
    },
    {
      title: "Multimedia Production",
      desc: "Video mapping, animasi 3D & motion graphics",
      url: "#services",
      tags: ["multimedia", "video", "animasi", "motion", "mapping", "3d"],
    },
    {
      title: "Creative Design",
      desc: "Branding visual, key visual & identitas brand",
      url: "#services",
      tags: ["creative", "kreatif", "desain", "design", "branding"],
    },
    {
      title: "Portfolio",
      desc: "Showcase proyek & dokumentasi karya terbaik",
      url: "#portfolio",
      tags: ["portfolio", "portofolio", "karya", "projek", "project", "galeri"],
    },
    {
      title: "Location / Alamat & Maps",
      desc: "Lokasi studio & kantor LUMINTU Creative Visual",
      url: "#location",
      tags: [
        "location",
        "lokasi",
    ...
    },
    {
      ...
      desc: "Integrasi teknologi visual canggih & panggung",
      url: "#visual-engineering",
      tags: ["visual", "engineering", "teknologi", "stage", "instalasi"],
    },
    {
      title: "Clients",
      desc: "Daftar klien & kolaborasi terpercaya",
      url: "#clients",
      tags: ["clients", "klien", "partner", "mitra", "kolaborasi"],
    },
    {
      title: "Contact / WhatsApp",
      desc: "Konsultasikan kebutuhan visual Anda (halo minlu)",
      url: "#contact",
      tags: [
        "contact",
        "kontak",
...
function renderPortfolioGrid(filter) {
  ...
  grid.innerHTML = filtered
    .map((item) => {
      const sizeClass =
        item.size === "large" ? "project--large" : "project--small";
      ...
      const imgCount = Array.isArray(item.images)
        ? item.images.length
        : cover
          ? 1
          : 0;
  ...
  container.querySelectorAll(".pf-tab").forEach((btn) => {
    btn.addEventListener("click", () => {
      container
        ...
        .forEach((b) => b.classList.remove("pf-tab--active"));
...
function initPortfolioModal() {
  ...
  backdrop.addEventListener("click", (e) => {
    if (e.target === backdrop) closePortfolioModal();
  });
...
function openPortfolioModal(item) {
  ...
  // Thumbnail strip
  thumbsEl.innerHTML = pmodalImages
    .map(
      (src, i) => `
  ...
  requestAnimationFrame(() =>
    backdrop.classList.add("pmodal-backdrop--visible"),
  );
}
...
function navigateModal(dir) {
  ...
  pmodalCurrentIndex =
    (pmodalCurrentIndex + dir + pmodalImages.length) % pmodalImages.length;
  updateModalImage();
}
...
function updateModalImage() {
  ...
  thumbsEl &&
    thumbsEl.querySelectorAll(".pmodal-thumb").forEach((btn, i) => {
